TokoVoipConfig = {
	...
	plugin_data = {
		...
		TSChannel = "RedSoulRP",
		TSPassword = "erdemerdem31", -- TeamSpeak channel password (can be empty)
		...
		TSChannelWait = "Hoşgeldiniz", -- You NEED tokovoip in the wait channel name!

		-- Blocking screen informations
		TSServer = "redsoulrp", -- TeamSpeak server address to be displayed on blocking screen
